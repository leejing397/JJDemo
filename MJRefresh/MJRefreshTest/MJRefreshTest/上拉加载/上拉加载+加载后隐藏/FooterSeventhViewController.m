...
@interface FooterSeventhViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic,strong)NSMutableArray *footerArrayM;
@property (nonatomic,strong)UITableView *footerTabelView;

@end

@implementation FooterSeventhViewController
...
//                    [_footerTabelView.mj_footer endRefreshingWithNoMoreData];
                    // 隐藏当前的上拉刷新控件
                    _footerTabelView.mj_footer.hidden = YES;
                }];
            });
        }];
